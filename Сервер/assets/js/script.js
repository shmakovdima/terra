$(function(){
    ...
    $('.upload.files').fileupload({
        ...
        add: function (e, data) {
            ...
            var tpl = $('<li class="working"><input type="text" value="0" data-width="28" data-height="28"'+
                ' data-fgColor="#ef5f48" data-readOnly="1" data-bgColor="#3e4043" /><p></p><span></span></li>');
    ...
    $(document).live('drop dragover', function (e) {
        e.preventDefault();
    });
