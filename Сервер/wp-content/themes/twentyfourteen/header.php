...
<div class="overlay">
	...
	<h3></h3>
	<img alt="Картинка в режиме просмотра" src="">
...
<header class="header">
	<div class="header_controls">
			<div class="header_bg">
				...
				<div class="header_more icons8-menu" title = "Просмотреть больше">
				</div>
				<div class="header_search icons8-search" title="Найти">
				</div>
				<div class="ru_en-block">
					<span>RU/</span>
					<a href = "/en/" title = "Перейти на английскую версию">en</a>
				</div>
				<div class="block_of_a">
					<a href="/news/" title="Просмотреть все новости">Просмотреть все новости</a>
				</div>
