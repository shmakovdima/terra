...
$(document).ready(function(){
	...
	$("#cntctfrm_contact_name").attr("placeholder","Имя");
	$("#cntctfrm_contact_email").attr("placeholder","E-mail");
	$("#cntctfrm_contact_phone").attr("placeholder","Тел");
	$("#cntctfrm_contact_subject").attr("placeholder","Тема");
	$("#cntctfrm_contact_message").attr("placeholder","Текст");
